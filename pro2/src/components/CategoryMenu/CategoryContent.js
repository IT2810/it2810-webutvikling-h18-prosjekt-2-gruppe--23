    ...
    render() {
        ...
        <div className="categoryContent">
            <div className="catPicture">
                ...
                selectCategory = {this.props.selectPictureCategory}></CategoryPicker>
            </div>
            <div className="catText">
                <b>Velg tekstkategori</b>
                <CategoryPicker id="catText" cat1 = "Cliches" name1="Klisjeer" 
                cat2="Jokes" name2="Vitser" cat3="Riddles" 
                name3="Gåter" selectCategory = {this.props.selectTextCategory}></CategoryPicker>
            </div>
            <div className="catSound">
                ...
                name3="Instrumenter" selectCategory = {this.props.selectSoundCategory}></CategoryPicker> 
            </div>
        </div>
        )
    }
